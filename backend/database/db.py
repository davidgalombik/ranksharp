...
async def seed_retailers():
    ...
    retailers_config = [
        ...
        dict(slug="crate-and-barrel", name="Crate & Barrel", base_url="https://www.crateandbarrel.com", country="US",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.crate_and_barrel.CrateAndBarrelAdapter",
        ...
        dict(slug="world-market", name="World Market", base_url="https://www.worldmarket.com", country="US",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.world_market.WorldMarketAdapter",
        ...
        dict(slug="pottery-barn", name="Pottery Barn", base_url="https://www.potterybarn.com", country="US",
             ...
             categories={"storage": "storage-organisation", "decor": "decorating-accessories"}),
        ...
        dict(slug="container-store", name="The Container Store", base_url="https://www.containerstore.com", country="US",
             tier=ScrapeTier.HTTP, adapter_class="scraper.adapters.tier2_http.container_store.ContainerStoreAdapter",
             categories={"storage": "kitchen", "decor": "gift-wrap"}),
        dict(slug="at-home", name="At Home", base_url="https://www.athome.com", country="US",
             tier=ScrapeTier.HTTP, adapter_class="scraper.adapters.tier2_http.at_home.AtHomeAdapter",
             categories={"storage": "storage", "decor": "home-decor"}),
        ...
        dict(slug="house-au", name="House", base_url="https://www.house.com.au", country="AU",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.house_au.HouseAUAdapter",
             categories={"storage": "kitchen-storage", "decor": "home-decor"}),
        ...
        dict(slug="dusk", name="Dusk", base_url="https://www.dusk.com.au", country="AU",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.dusk.DuskAdapter",
        ...
        dict(slug="david-jones", name="David Jones", base_url="https://www.davidjones.com", country="AU",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.david_jones.DavidJonesAdapter",
             categories={"storage": "storage", "decor": "home-decor"}),
        dict(slug="myer", name="Myer", base_url="https://www.myer.com.au", country="AU",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.myer.MyerAdapter",
             categories={"storage": "storage", "decor": "home-decor"}),
        ...
        dict(slug="oliver-bonas", name="Oliver Bonas", base_url="https://www.oliverbonas.com", country="GB",
             tier=ScrapeTier.BROWSER, adapter_class="scraper.adapters.tier3_browser.oliver_bonas.OliverBonasAdapter",
             categories={"storage": "storage", "decor": "home"}),
        ...
        dict(slug="mudpie", name="Mud Pie", base_url="https://www.mudpie.com", country="US",
             tier=ScrapeTier.HTTP, adapter_class="scraper.adapters.tier2_http.mudpie.MudPieAdapter",
             categories={"decor": "home-decor"}),
