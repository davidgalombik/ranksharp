"""
Next AU adapter (next.com.au).

Next AU is the Australian arm of the UK fashion/home retailer.
Same platform as Next UK — server-side rendering with JSON-LD.
"""
import json
import httpx
...
CATEGORY_PATHS = [
    "/shop/au/s/home/storage",
    "/shop/au/s/home/homeaccessories",
    "/shop/au/s/home/kitchen",
    "/shop/au/s/home/bedroom",
    "/shop/au/s/home/bathroom",
]


class NextAUAdapter(BaseAdapter):
    RETAILER_SLUG = "next-au"
