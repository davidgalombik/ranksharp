"""Kmart AU adapter — JSON-LD + __NEXT_DATA__ parsing."""
...
CATEGORY_PATHS = [
    "/category/home-living/storage-organisation/",
    "/category/home-living/homewares/",
...
class KmartAUAdapter(BaseAdapter):
    ...
    async def get_product_urls(self, category_url):
        ...
        for page in range(1, 6):
            ...
            if not soup.select_one("[aria-label='Next page'], a[rel='next']"): break
        return urls
    ...
    async def parse_product(self, url):
        ...
        name = soup.select_one("h1[data-testid='product-title'], h1")
