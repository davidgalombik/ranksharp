"""Target AU adapter — JSON-LD + category page scraping."""
...
CATEGORY_PATHS = ["/c/storage-organisation/", "/c/home-decor/", "/c/homewares/"]
...
class TargetAUAdapter(BaseAdapter):
    ...
    async def get_product_urls(self, category_url):
        ...
        for page in range(1, 6):
            resp = await self._client.get(category_url, params={"pageNumber": page})
